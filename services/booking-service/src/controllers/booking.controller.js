    ...
    try {
      const result = await this.db.query(
        `SELECT b.id, b.reference, b.status, b.payment_status, b.trip_type, b.cabin_class,
                ...
                f.origin_iata, f.destination_iata,
                to_char(f.departure_time AT TIME ZONE ao.timezone, 'YYYY-MM-DD"T"HH24:MI:SS') AS departure_time,
                to_char(f.arrival_time AT TIME ZONE ad.timezone, 'YYYY-MM-DD"T"HH24:MI:SS') AS arrival_time,
                f.duration_minutes, f.stops,
                ao.city AS origin_city, ao.name AS origin_name,
                ad.city AS destination_city, ad.name AS destination_name,
                ...
                to_char(rf.departure_time AT TIME ZONE rfo.timezone, 'YYYY-MM-DD"T"HH24:MI:SS') AS rf_departure_time,
                to_char(rf.arrival_time AT TIME ZONE rfd.timezone, 'YYYY-MM-DD"T"HH24:MI:SS') AS rf_arrival_time,
