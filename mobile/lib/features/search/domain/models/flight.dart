...
class Flight {
  ...
  factory Flight.fromJson(Map<String, dynamic> json) {
    return Flight(
      ...
      departureTime: json['departure_time'] != null ? DateTime.parse(json['departure_time']).toLocal() : DateTime.now(),
      arrivalTime: json['arrival_time'] != null ? DateTime.parse(json['arrival_time']).toLocal() : DateTime.now(),
